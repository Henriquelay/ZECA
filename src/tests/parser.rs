...
pub fn test() {
    ...
    assert!(crate::grammar::ProgramParser::new().parse("continue").is_ok());
    ...
    assert!(crate::grammar::ProgramParser::new().parse("something").is_err());
    assert!(crate::grammar::ProgramParser::new().parse("CONTINUE").is_err());
    assert!(crate::grammar::ProgramParser::new().parse("Continue").is_err());
    assert!(crate::grammar::ProgramParser::new().parse("CoNtInUe").is_err());
}
